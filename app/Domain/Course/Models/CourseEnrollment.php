...
class CourseEnrollment extends Model
{
    ...
    {
        // Por defecto 50/50, pero se puede obtener de la configuración del sistema
        return [
            'interactive' => 50,
            'activities' => 50,
        ];
    ...
    {
        $progress = $this->calculateProgress();
        $threshold = 80; // Se puede obtener de configuración

        return $progress['overall'] >= $threshold;
    }
    ...
    public function canGetCompleteCertificate(): bool
    {
        ...
        $threshold = 70; // Se puede obtener de configuración
